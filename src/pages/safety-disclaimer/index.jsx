  ...
  return (
    <div className="safety-body">
      ...
      <p>
        ...
        used, and exercise judgment regarding age-appropriateness. Do not allow
        children under 3 years old to participate in activities involving small
        ingredients or supplies that could pose a choking hazard. Adult
        <br />
        <br />
        Supervision: All activities and crafts should be conducted under adult
